...
chr_plot_df_2$V4 <- ifelse(chr_plot_df_2$V3.x+150000<=chr_plot_df_2$V3.y,chr_plot_df_2$V3.x+150000,chr_plot_df_2$V3.y)
...
chrom_bg+
  geom_segment(data=chr_plot_df_2[which(chr_plot_df_2$group=="gain"),],
               aes(x=V1,xend=V1,y=V2.x,yend=V4,color="gain"),
                      size = 3,position=position_nudge(x = 0.25))+
